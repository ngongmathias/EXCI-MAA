...
DROP FUNCTION IF EXISTS check_admin_status(TEXT, TEXT);
DROP FUNCTION IF EXISTS create_admin_user(TEXT, TEXT, TEXT, TEXT, TEXT[]);
DROP FUNCTION IF EXISTS update_admin_user(TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, TEXT[]);
DROP FUNCTION IF EXISTS delete_admin_user(TEXT);

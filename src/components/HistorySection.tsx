...
const timeline = [
  {
    ...
    icon: <Building2 className="h-6 w-6 text-exci-blue-600" />
  },
  {
    id: 2,
    year: '2002',
    ...
    icon: <MapPin className="h-6 w-6 text-exci-blue-600" />
  },
  {
    id: 3,
    year: '2010',
    ...
    icon: <Award className="h-6 w-6 text-exci-blue-600" />
  },
  {
    id: 4,
    year: '2015',
    ...
    icon: <BarChart2 className="h-6 w-6 text-exci-blue-600" />
  },
  {
    id: 5,
    year: '2020',
    ...
    icon: <Globe className="h-6 w-6 text-exci-blue-600" />
  },
  {
    id: 6,
    year: '2023',
    ...
    icon: <Users className="h-6 w-6 text-exci-blue-600" />
  }
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    ...
                    <div className={`w-1/2 p-6 ${index % 2 === 0 ? 'pr-12 text-right' : 'pl-12'}`}>
                      ...
                      <div className="mt-2 text-sm font-medium text-exci-blue-600">{item.year}</div>
                    </div>
                    
                    {/* Dot */}
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center w-12 h-12 rounded-full bg-exci-blue-100 border-4 border-white shadow-lg">
                      {item.icon}
                    </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="mt-6">
            <a
              href="#"
              className="inline-flex items-center rounded-md bg-exci-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-exci-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-exci-blue-600"
            >

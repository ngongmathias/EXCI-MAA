...
export const offices: Office[] = [
  ...
  {
    id: '10',
    name: 'EXCI-MAA Kampala',
    address: 'Plot 3, Portal Avenue',
    city: 'Kampala',
    country: 'Uganda',
    coordinates: {
      lat: 0.3136,
    ...
    image: '/images/offices/kampala.jpg',
    googleMapsUrl: 'https://maps.app.goo.gl/kampala',
  },
  {
    id: '11',
    name: 'EXCI-MAA Dar es Salaam',
    address: 'Ohio Street, CBD',
    city: 'Dar es Salaam',
    country: 'Tanzania',
    coordinates: {
      lat: -6.7924,
    ...
    image: '/images/offices/daressalaam.jpg',
